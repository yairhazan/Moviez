...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.message.includes('registered with Google')) {
        setError('This email is already registered with Google. Please use the "Sign up with Google" button below.')
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      } else if (err.message.includes('different sign-in method')) {
          ...
          {error && (
            <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
              ...
              {error.includes('already registered') && (
                <Link href="/login" className="block mt-2 text-red-700 underline hover:text-red-800">
                  Go to Sign In
                </Link>
              )}
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700 placeholder-gray-500 text-white focus:outline-none focus:ring-red-500 focus:border-red-500 focus:z-10 sm:text-sm bg-gray-800 pl-10"
